...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='NYU', help='path of the dataset')
...
parser.add_argument('--ndf', dest='ndf', type=int, default=64, help='# of descriptor filters in first conv layer')
